...
const StyledTooltip = styled('div')`
  ...
  background: #fff;
  text-align: left;
  box-shadow: 0px 8px 11px 1px rgb(0 0 0 / .5);
...
const Serverities = (props: IServeritiesProps) => {
  ...
  return <div style={{ marginLeft: '4px', display: 'inline-block' }}>
    {
          ...
          <div key={'tooltip-item-' + index}>
            <div style={{ display: 'flex' }}>
              <p style={{ display: 'inline-block', margin: 0 }}>
                Serverity: <span style={{ fontWeight: 'bold' }}>{item.severity}</span>
              </p>
            ...
            <a target="_blank" rel="noreferrer" href={item.advisory.permalink}>Learn more</a>
            <hr/>
          </div>
        )
      })
